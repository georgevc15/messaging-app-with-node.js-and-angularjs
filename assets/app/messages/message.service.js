...
var MessageService = /** @class */ (function () {
    ...
    MessageService.prototype.addMessage = function (message) {
        ...
        return this.http.post('http://localhost:3000/message' + token, body, { headers: headers })
            ...
            var message = new message_model_1.Message(result.obj.content, result.obj.user.firstName, result.obj_id, result.obj.user._id);
    ...
    MessageService.prototype.deleteMessage = function (message) {
        ...
        var token = localStorage.getItem('token')
            ? '?token=' + localStorage.getItem('token')
            : '';
        return this.http.delete('http://localhost:3000/delete' + message.messageId + token)
            .map(function (response) { return response.json(); })
            .catch(function (error) { return rxjs_1.Observable.throw(error.json()); });
    };
